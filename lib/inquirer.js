        ...
        const questions = [
            {
                type: 'list',
                name: 'startans',
                message: 'Welcome to Vericlasify, choose the operation to perform',
        ...
        const questions = [
            {
                type: 'list',
                name: 'gitignore',
                message: 'Vericlasify will now proceed to create a commit with all the files and\n'
